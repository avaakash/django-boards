...
urlpatterns = [
    ...
    url(r'^login/$', auth_views.LoginView.as_view(template_name='login.html'), name='login'),
     url(r'^boards/(?P<pk>\d+)/topics/(?P<topic_pk>\d+)/posts/(?P<post_pk>\d+)/$',board_views.PostUpdateView.as_view(), name='edit_post'),
    url(r'^boards/(?P<pk>\d+)/topics/(?P<topic_pk>\d+)/$', board_views.PostListView.as_view(), name='topic_posts'),
    url(r'^boards/(?P<pk>\d+)/topics/(?P<topic_pk>\d+)/reply/$', board_views.reply_topic, name='reply_topic'),
    url(r'^boards/(?P<pk>\d+)/$', board_views.TopicListView.as_view(), name = 'board_topics'),
    url(r'^boards/(?P<pk>\d+)/new/$', board_views.new_topic, name='new_topic'),
    url(r'^settings/account/$', board_views.UserUpdateView.as_view(),name='my_account'),
]
